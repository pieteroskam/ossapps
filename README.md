...
* [Golf GPS](https://github.com/pieteroskam/Fitbit-Golf-GPS) by Pieter Oskam - Show distances to Greens, hazards etc (uses geolocation, filetransfer, file sync, messaging, tile list, scroll-view)
